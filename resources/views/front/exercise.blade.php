...
<head>
  ...
  <title>Exercices-AlgoLock</title>
    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="/exercise"class="active">Exercices</a></li>
      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>Exercices</h1>
              <p class="mb-0">La pratique régulière d'exercices est cruciale pour maîtriser les algorithmes. Elle développe les compétences nécessaires à l'analyse, à la conception et à l'évaluation des solutions, renforce la compréhension des structures de données et des algorithmes, et prépare à résoudre des problèmes réels.</p>
            </div>
          </div>
        </div>
      </div>
