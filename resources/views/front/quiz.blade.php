      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>Quiz</h1>
              <p class="mb-0">Les quiz sont essentiels pour l'apprentissage des algorithmes car ils permettent aux étudiants de tester leur compréhension, d'identifier leurs forces et faiblesses, et d'approfondir leurs connaissances.</p>
            </div>
          </div>
        </div>
      </div>
